<?php
/* carica il file in altervista e correggi tutti gli errori*/
...
function miaFunzione_3() { echo "x : " . $GLOBALS[x]; } 
...
Vediamo ora un esempio di assegnazione e scorrimento di un array classico, mediante alcune delle funzioni
sopracitate :
*/
